				...
				do {
					...
					if ( roll == 1 ) {
						...
						if( turnTotal < 20 && ctot+turnTotal >= 100)
							System.out.println("\t Computer will not risk the win to roll again!!!");
						else if ( turnTotal < 20 && ctot+turnTotal < 100) { //added less than 100 total so it doesn't say it will roll again.
							System.out.println( "\tComputer will roll again." );
						}
					}
				} while ( roll != 1 && turnTotal < 20  && ctot+turnTotal <= 100);//simple?
