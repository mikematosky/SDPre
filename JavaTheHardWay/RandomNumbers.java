public class RandomNumbers {
	public static void main( String[] args ) {
		...
		//nums 1-3 are from 1-3
		num1= 1+(int)(3*Math.random());
		num2= 1+(int)(3*Math.random());
		num3= 1+(int)(3*Math.random());

		//nums 4-6 are from 5-10
		num4= 5+(int)(6*Math.random());
		num5= 5+(int)(6*Math.random());
		num6= 5+(int)(6*Math.random());

		System.out.println("Random Numers 1-3=    "+num1+"    "+num2+"    "+num3);
		System.out.println("Random Numers 5-10=    "+num4+"    "+num5+"    "+num6);
	}
}

/*
	1&2) I have confirmed that the random numbers for the first group range from 1 to 3
	and the second group are 5-10.
